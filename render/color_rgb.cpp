...
const ColorRGB ColorRGB::BlueViolet       (0.623529, 0.372549, 0.623529);
const ColorRGB ColorRGB::Brown            (0.647059, 0.164706, 0.164706);
const ColorRGB ColorRGB::CadetBlue        (0.372549, 0.623529, 0.623529);
const ColorRGB ColorRGB::Coral            (1.0,      0.498039, 0.0);
const ColorRGB ColorRGB::CornflowerBlue   (0.258824, 0.258824f, 0.435294f);
const ColorRGB ColorRGB::Cyan             (0.0,      1.0f,      1.0f);
const ColorRGB ColorRGB::DarkGreen        (0.184314, 0.309804f, 0.184314f);
const ColorRGB ColorRGB::DarkOliveGreen   (0.309804, 0.309804f, 0.184314f);
const ColorRGB ColorRGB::DarkOrhid        (0.6,      0.195078f, 0.8f);
const ColorRGB ColorRGB::DarkSlateBlue    (0.419608, 0.137255f, 0.556863f);
const ColorRGB ColorRGB::DarkSlateGray    (0.184314, 0.309804f, 0.309804f);
const ColorRGB ColorRGB::DarkSlateGrey    (0.184314, 0.309804f, 0.309804f);
const ColorRGB ColorRGB::DarkTurquiose    (0.439216, 0.576471f, 0.858824f);
const ColorRGB ColorRGB::DimGray          (0.329412, 0.329412f, 0.329412f);
const ColorRGB ColorRGB::DimGrey          (0.329412, 0.329412f, 0.329412f);
const ColorRGB ColorRGB::Firebrick        (0.9,      0.4f,      0.3f);
const ColorRGB ColorRGB::ForestGreen      (0.137255, 0.556863, 0.137255);
const ColorRGB ColorRGB::Gold             (0.8,      0.498038, 0.196078);
const ColorRGB ColorRGB::Goldenrod        (0.858824, 0.858824, 0.439126);
const ColorRGB ColorRGB::Gray             (0.752941, 0.752941, 0.752941);
const ColorRGB ColorRGB::Green            (0.0,      1.0,      0.0);
const ColorRGB ColorRGB::GreenYellow      (0.576471, 0.858824, 0.439216);
const ColorRGB ColorRGB::Grey             (0.752941, 0.752941, 0.752941);
const ColorRGB ColorRGB::Grey25           ((unsigned int)0x404040);
